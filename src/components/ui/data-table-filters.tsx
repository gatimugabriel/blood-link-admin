                ...
                {values.length > 0 && (
                    <div className={`flex items-center gap-1`}>
                        <Button
                            ...
                            size="sm"
                            onClick={onReset}
                            className="p-1 text-xs peer"
                        >
                            Clear all
                        </Button>

                        <div className="flex flex-wrap gap-2 border-[0.5px] border-indigo-600 peer-hover:animate-pulse peer-hover:border-red-500 duration-300 rounded-lg p-2">
                            {values.map((filter) => (
                                <Badge
                                    key={filter.id}
                                    variant="secondary"
                                ...
                                >
                                    ...
                                    <Button
                                        ...
                                        className="h-auto p-0 hover:text-destructive-100 cursor-pointer"
                                    >
                                        <X className="h-3 w-3"/>
                                    </Button>
                                </Badge>
